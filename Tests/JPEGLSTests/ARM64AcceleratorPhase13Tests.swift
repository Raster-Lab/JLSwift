/// Tests for the Phase 13.1 ARM64 Neon enhancements.
///
/// These tests cover the Golomb-Rice parameter computation, run-length
/// detection, and byte stuffing detection added to ARM64Accelerator as
/// part of Milestone 13 Phase 13.1.
///
/// All tests are compiled and run only on ARM64 architectures where
/// the ARM64Accelerator is available.
